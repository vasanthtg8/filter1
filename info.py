...
URL = "moviesuniverse-704fef876ee6.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "moviesuniverse-704fef876ee6.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "moviesuniverse-704fef876ee6.herokuapp.com/".format(FQDN)
else:
    URL = "moviesuniverse-704fef876ee6.herokuapp.com/".format(FQDN)
