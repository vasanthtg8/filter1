...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+ntGBpf8UhmFkNmQ1')
...
URL = "https://movieloverzz-movieloverzzbot.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movieloverzz-movieloverzzbot.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movieloverzz-movieloverzzbot.koyeb.app/".format(FQDN)
else:
    URL = "https://movieloverzz-movieloverzzbot.koyeb.app/".format(FQDN)
